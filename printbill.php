...
$total_amount = $conn->real_escape_string($_POST['total_fare']);
...
?>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                ...
                <!-- <h4>Please ensure that car is parked in safe area.</h4> -->
                <br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        echo "<p><h4> <strong>Arrival at: </strong>" . htmlspecialchars($userInput) . "</p>";
    }
    ?></h4>
                <br>
            </div>
