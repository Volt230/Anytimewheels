...
<head>
    <title> Customer Signup | Anytime Wheels  </title>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Anytime Wheels - Registration</h1>
            <br>
                ...
                <div class="panel-body">
                  ...
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></label>
                        ...
                        <div class="row">
                            ...
                            <div class="input-group">
                                <input class="form-control" id="customer_phone" type="tel" name="customer_phone" pattern="\d{10}" placeholder="Phone" required="">
                                <span class="input-group-btn">
