...
<?php
    ...
    if($err_date >= 0) {
        if (($_POST['driver_id_from_dropdown'])!="None") {
            $driver_id = $_POST['driver_id_from_dropdown'];
            $sql1 = "INSERT into rentedcars(customer_username, car_id, driver_id, booking_date, rent_start_date, rent_end_date, fare, charge_type, return_status, city) 
            VALUES('$customer_username', '$car_id', '$driver_id', '" . date("Y-m-d") . "', '$rent_start_date', '$rent_end_date', '$fare', '$charge_type', '$return_status', '$city')";
            ...
            $sql1 = "INSERT into rentedcars(customer_username,car_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status, city) 
            VALUES('" . $customer_username . "','" . $car_id .  "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "','" . $city . "')" ;
            $result1 = $conn->query($sql1);
            ...
            $sql4 = "SELECT * FROM cars c, clients cl,clientcars cc,rentedcars rc WHERE c.car_id ='$car_id' AND cc.car_id ='$car_id' AND cl.client_username=cc.client_username";
            $result4 = $conn->query($sql4);
        }
        
    $rs=mysqli_num_rows($result4);
    echo "result: $rs";
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>Client City: </strong> <?php echo $city; ?> </h4>
                <br>
                <h4> <strong>Start Date: </strong> <?php echo $rent_start_date; ?></h4>
                <br>
                <h4> <strong>Return Date: </strong> <?php echo $rent_end_date; ?></h4>
                <br>
                <?php if (($_POST['driver_id_from_dropdown'])!="None"){?>
