...
<head>
    ...
    <title>FAQ | Anytime Wheels</title>
</head>
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>One of the many great things about AnytimeWheels is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable vehicle including the same terms, locations, and rental car fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>A driving license is not mandatory.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>AnytimeWheels gladly accepts MasterCard, Visa, and checks. We also PayTm.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">What if car is dented or accident happens by-mistake?</a>
                    <div class="cd-faq-content">
                        <p>The repair cost will be your responsibility and extra charges for the compensation</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if I change my location at the last moment?</a>
                    <div class="cd-faq-content">
                        <p>There is no fee for location change at the last moment, although a little delay is expected!
